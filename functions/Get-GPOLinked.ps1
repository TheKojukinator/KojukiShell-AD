Function Get-GPOLinked {
    ...
    Process {
        try {
            ...
            # append SearchBase if it's provided
                ...
                foreach ($link in $ou.LinkedGroupPolicyObjects) {
                    ...
                    if ($guid.Length -eq 36) {
                        ...
                        if ($obj) {
                            ...
                            # finally, append the object to the results array
                            $results += $obj
                        }
                    }
                }
            ...
            if ($Unique) {
                ...
                we're interested in the top-most link as would be easier for the user to work with.
                So, we're going to sort by the OU length and then the OU string, then group
                by GUID, and only output the first item of the group. Then resort for final display.
            #>
